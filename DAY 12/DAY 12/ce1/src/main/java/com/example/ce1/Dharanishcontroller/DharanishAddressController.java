...
import com.example.ce1.Dharanishservice.DharanishAddressService;
...
public class DharanishAddressController {
    ...
    @Autowired
    DharanishAddressService addressService;

    @SuppressWarnings("null")
    @PostMapping("/address/employee/{id}")
    public ResponseEntity<DharanishAddress> postMethodName(@RequestBody DharanishAddress address,@PathVariable int id) {
