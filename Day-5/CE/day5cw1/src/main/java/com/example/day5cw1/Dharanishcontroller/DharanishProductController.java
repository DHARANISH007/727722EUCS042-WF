package com.example.day5cw1.Dharanishcontroller;

import org.springframework.web.bind.annotation.RestController;

import com.example.day5cw1.DharanishModel.DharanishProduct;
import com.example.day5cw1.DharanishService.DharanishProductService;
...
public class DharanishProductController {
    ...
    public ResponseEntity<DharanishProduct> putMethodName(@PathVariable("productId") int id, @RequestBody DharanishProduct product) {
    ...
    public ResponseEntity<DharanishProduct> delete(@PathVariable("productId") int id,@RequestBody DharanishProduct product)
    {
