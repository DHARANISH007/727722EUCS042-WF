...
public class DharanishVillage {
    ...
    public DharanishVillage(){}
    public DharanishVillage(int villageId, String villageName, int numOfMen, int numOfWomen, int villagePopulation,
            int numOfSchools) {
