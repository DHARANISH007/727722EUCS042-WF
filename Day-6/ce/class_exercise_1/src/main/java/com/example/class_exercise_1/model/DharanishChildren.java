...
@Entity
public class DharanishChildren {
     @Id
     private int babyId;
     ...
     public DharanishChildren() {

     }

     public DharanishChildren(int babyId, String babyFirstName, String babyLastName, String fatherName, String motherName,
               String address) {
          this.babyId = babyId;
