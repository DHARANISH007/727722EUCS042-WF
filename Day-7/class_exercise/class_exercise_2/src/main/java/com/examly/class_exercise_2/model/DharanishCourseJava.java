...
@Entity
public class DharanishCourseJava {
     ...
     public DharanishCourseJava() {

     }

     public DharanishCourseJava(int courseId, String courseName, int creditHours, String instructor, String preRequistes,
